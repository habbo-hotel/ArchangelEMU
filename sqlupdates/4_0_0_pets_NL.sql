...
) ENGINE=Aria DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci PAGE_CHECKSUM=1 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `pet_vocals` (`pet_id`, `type`, `message`) VALUES
	(15, 'DISOBEY', 'Nee, dat ga ik echt niet doen!'),
	(15, 'DISOBEY', 'Wie denk je wel wie ik ben?'),
	(15, 'DISOBEY', 'Sorry, maar dat ga ik niet doen!'),
	...
	(35, 'DISOBEY', 'Nee, dat ga ik echt niet doen!'),
	(35, 'DISOBEY', 'Wie denk je wel wie ik ben?'),
	(35, 'DISOBEY', 'Sorry, maar dat ga ik niet doen!'),
	(35, 'GENERIC_HAPPY', '*blij* In de wei?'),
	(35, 'GENERIC_HAPPY', 'Ik geloof dat ik iets voel bubbelen van blijdschap. Of heb ik last van gas in mijn maag.. :S'),
	(35, 'GENERIC_HAPPY', ':)'),
	(35, 'GENERIC_NEUTRAL', 'Hallo!'),
	(35, 'GENERIC_NEUTRAL', 'Hoe sta jij ervoor vandaag?'),
	(35, 'GENERIC_NEUTRAL', 'Bah....'),
	(35, 'GENERIC_SAD', 'Ik voel me vandaag niet helemaal mezelf...'),
	(35, 'GENERIC_SAD', 'Tranen.. Er biggelen tranen uit mijn ogen...'),
	(35, 'GREET_OWNER', 'Ha! Mijn eigenaar? Wat klinkt dat gek, eigenlijk....'),
	(35, 'GREET_OWNER', 'Ik vind het fantastisch je weer te zien! *high five*'),
	(35, 'HUNGRY', 'Ik heb honger.. als een paard. Maar dat is een inkoppertje.'),
	(35, 'LEVEL_UP', 'Woeps. Weer een level hoger!'),
	(35, 'MUTED', '*stilte*'),
	(35, 'PLAYFUL', 'Zullen we wat leuks doen vandaag?'),
	(35, 'PLAYFUL', 'Verveling.. de verveling slaat toe...'),
	(35, 'SLEEPING', 'ZzzzZZzzz.. er staat een... ZzzZZZ... schaap in de gang....Zzzz. Hey! Hooi!'),
	(35, 'SLEEPING', 'Zzzz...niemand kan mijn wilde hart temmen...zzZZzzz...'),
	(35, 'SLEEPING', 'Zzzz...en toen huppelde ik door de wei.. ZzzzZZ'),
	(35, 'THIRSTY', 'Dorst! Als een paard..'),
	(35, 'TIRED', 'Moe... Als een ...?  Ja, ik hou nu op! :P'),
	(35, 'UNKNOWN_COMMAND', 'I\'m sorry! Ik snap er helemaal niks van!'),
	(35, 'UNKNOWN_COMMAND', 'Whatever.. dat gehinnik van jou is zo moeilijk te verstaan ;)'),
	(35, 'DRINKING', 'Ah, zalig spul.. water.'),
	(35, 'EATING', 'Dit is zalig!!'),
