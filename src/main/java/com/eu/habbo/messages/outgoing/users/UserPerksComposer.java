...
public class UserPerksComposer extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        this.response.appendBoolean(this.habbo.getHabboInfo().getPermissionGroup().hasPermissionRight(Permission.ACC_HELPER_USE_GUIDE_TOOL, false));


        this.response.appendString("GIVE_GUIDE_TOURS");
        this.response.appendString("");
        this.response.appendBoolean(this.habbo.getHabboInfo().getPermissionGroup().hasPermissionRight(Permission.ACC_HELPER_GIVE_GUIDE_TOURS, false));

        this.response.appendString("JUDGE_CHAT_REVIEWS");
        this.response.appendString("requirement.unfulfilled.helper_level_6");
        this.response.appendBoolean(this.habbo.getHabboInfo().getPermissionGroup().hasPermissionRight(Permission.ACC_HELPER_JUDGE_CHAT_REVIEWS, false));
        ...
        this.response.appendBoolean(this.habbo.getHabboInfo().getPermissionGroup().hasPermissionRight(Permission.ACC_FLOORPLAN_EDITOR, false));
        ...
        this.response.appendString("");
        this.response.appendBoolean(this.habbo.getHabboInfo().getPermissionGroup().hasPermissionRight(Permission.ACC_CAMERA, false));
