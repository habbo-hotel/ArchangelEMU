...
public class ModeratorInitMessageComposer extends MessageComposer implements TObjectProcedure<ModToolCategory> {
    ...
    protected ServerMessage composeInternal() {
        ...
        if (this.habbo.hasPermissionRight(Permission.ACC_MODTOOL_TICKET_Q)) {
        ...
        this.response.appendBoolean(this.habbo.hasPermissionRight(Permission.ACC_MODTOOL_TICKET_Q)); //ticketQueueueuhuehuehuehue
        this.response.appendBoolean(this.habbo.hasPermissionRight(Permission.ACC_MODTOOL_USER_LOGS)); //user chatlogs
        this.response.appendBoolean(this.habbo.hasPermissionRight(Permission.ACC_MODTOOL_USER_ALERT)); //can send caution
        this.response.appendBoolean(this.habbo.hasPermissionRight(Permission.ACC_MODTOOL_USER_KICK)); //can send kick
        this.response.appendBoolean(this.habbo.hasPermissionRight(Permission.ACC_MODTOOL_USER_BAN)); //can send ban
        this.response.appendBoolean(this.habbo.hasPermissionRight(Permission.ACC_MODTOOL_ROOM_INFO)); //room info ??Not sure
        this.response.appendBoolean(this.habbo.hasPermissionRight(Permission.ACC_MODTOOL_ROOM_LOGS)); //room chatlogs ??Not sure
